...
export default function ContactCard() {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col md:flex-row items-center justify-between gap-10 px-6 py-12 md:p-16 bg-gradient-to-br from-[#f0f4ff] to-[#e6f7ff] rounded-3xl overflow-hidden shadow-xl"
    >
      {/* Background Blurs */}
